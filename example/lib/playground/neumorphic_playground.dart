...
class __PageState extends State<_Page> {
  ...
  Widget neumorphic() {
    return NeumorphicButton(
      ...
      drawSurfaceAboveChild: this.drawAboveChild == true,
      ...
      child: SizedBox(
        height: height,
        width: width,
        child: haveNeumorphicChild == true
            ? neumorphicChild()
            : Container(
                //color: Colors.blue,
    ...
    return Neumorphic(
      ...
      style: NeumorphicStyle(
          ...
          oppositeShadowLightSource:
              this.childOppositeLightsourceChild == true),
  ...
  Widget cornerRadiusSelector() {
    if (boxShape?.isRoundRect == true || boxShape?.isBeveled == true) {
      return Row(
        children: <Widget>[
          Padding(
            padding: EdgeInsets.only(left: 12),
          ...
          Expanded(
            child: Slider(
              ...
              onChanged: (value) {
                setState(() {
                  cornerRadius = value;
                  if (boxShape?.isRoundRect == true) {
                    boxShape = NeumorphicBoxShape.roundRect(
                        BorderRadius.circular(this.cornerRadius));
                  }
                  if (boxShape?.isBeveled == true) {
          ...
          child: Padding(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                "Rect",
                style: TextStyle(
                    color: boxShape?.isRoundRect == true
                        ? textActiveColor
                        : textInactiveColor),
              ),
            ),
          ...
          child: Padding(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                "Custom",
                style: TextStyle(
                    color: boxShape?.isCustomPath == true
                        ? textActiveColor
                        : textInactiveColor),
              ),
            ),
